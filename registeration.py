...
#containing all the details given by user
...
#cleaning the box after entering the records

    nameEntry.delete(0, END)
    phoneEntry.delete(0, END)
    emailEntry.delete(0, END)
    
    Label(text="Registration Success",fg="green",font=("Calibri",11)).place(x=250,y=380)

#labeling the registration window
    
#labeliing the boxes
    
Label(root, text="College Registration Form", font="arial 25").pack (pady=50)
...
Label(text="Gender", font=23). place (x=100, y=300)
...
genderValue.set("Select the gender") #default Value
drop=OptionMenu(root, genderValue, "Male","Female","Others").place(x=200,y=300)
